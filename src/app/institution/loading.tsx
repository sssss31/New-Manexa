  ...
  return (
    <div className="relative animate-pulse" aria-busy="true" aria-label="Loading dashboard">
      <div className="flex items-end justify-between mb-7">
        <div>
          <div className="h-5 w-24 rounded-full bg-white/[0.06] mb-3" />
          <div className="h-9 w-72 rounded-xl bg-white/[0.06]" />
          <div className="h-4 w-56 rounded-lg bg-white/[0.04] mt-2" />
        </div>
