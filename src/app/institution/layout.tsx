  ...
  return (
    <AppShell
      ...
      nav={[
        ...
        { section: "Overview", href: "/institution/calendar", label: "Calendar", icon: <IconCalendar /> },
        ...
        { section: "Face Attendance", href: "/institution/face/enroll", label: "Student enrolment", icon: <IconUsers /> },
        { section: "Face Attendance", href: "/institution/face/enroll-staff", label: "Staff enrolment", icon: <IconUsers /> },
        ...
        { section: "Operations", href: "/institution/procurement", label: "Procurement", icon: <IconMoney /> },
        { section: "Operations", href: "/institution/visitors", label: "Visitors", icon: <IconShield /> },
        { section: "Operations", href: "/institution/tasks", label: "Tasks", icon: <IconWorkflow /> },
        ...
        { section: "System", href: "/institution/leave", label: "Staff Leave", icon: <IconCalendar /> },
