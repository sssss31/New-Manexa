  ...
  return (
    <AppShell
      ...
      nav={[
        ...
        { section: "Today", href: "/teacher/attendance", label: "Attendance", icon: <IconClipboard /> },
        { section: "Today", href: "/teacher/attendance/live", label: "Face Attendance", icon: <IconFace /> },
