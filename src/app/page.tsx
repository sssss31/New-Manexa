  ...
  return (
    <main className="relative min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section className="relative pt-36 pb-24 px-4 mkt-noise">
        ...
        <div className="mkt-orb mkt-orb-emerald w-[440px] h-[440px] top-10 right-[-120px] mkt-drift" aria-hidden style={{ animationDelay: "-6s" }} />
        <div className="mkt-orb mkt-orb-cyan w-[380px] h-[380px] top-[420px] left-1/4 mkt-drift" aria-hidden style={{ animationDelay: "-10s" }} />
      ...
      <section id="product" className="relative py-28 px-4 border-t border-white/8">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
          ...
          <Reveal delay={0.1} className="relative">
            <div className="absolute -inset-6 mkt-orb mkt-orb-emerald opacity-30" aria-hidden />
