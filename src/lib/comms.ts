...
export function otpEmailHtml(opts: { code: string; purpose: string; minutes: number }): string {
  ...
  return `<!doctype html><html><body style="margin:0;background:#0b0f0c;padding:32px 0;font-family:Segoe UI,Roboto,Helvetica,Arial,sans-serif">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td align="center">
    <table role="presentation" width="440" cellpadding="0" cellspacing="0" style="background:#12171400;border:1px solid #26302a;border-radius:16px;overflow:hidden;background-color:#12171a">
      <tr><td style="padding:28px 32px 8px 32px">
        <div style="font-size:20px;font-weight:700;color:#e9f0ec;letter-spacing:-0.5px">MANEXA</div>
        <div style="font-size:12px;color:#7c8a82;margin-top:2px">AI-Powered Education OS</div>
      </td></tr>
      <tr><td style="padding:12px 32px 0 32px">
        <h1 style="font-size:20px;color:#e9f0ec;margin:12px 0 6px 0">${title}</h1>
        <p style="font-size:14px;color:#9aa8a0;line-height:1.5;margin:0 0 20px 0">Enter this code to confirm it's you. It expires in ${opts.minutes} minutes.</p>
        <div style="text-align:center;margin:8px 0 20px 0">
          <span style="display:inline-block;font-size:34px;letter-spacing:10px;font-weight:700;color:${brand};background:#0d130f;border:1px solid #26302a;border-radius:12px;padding:16px 22px">${opts.code}</span>
        </div>
        <p style="font-size:12px;color:#6b7a71;line-height:1.5;margin:0 0 8px 0">If you didn't request this, you can safely ignore this email — no changes will be made to your account.</p>
      </td></tr>
      <tr><td style="padding:16px 32px 28px 32px;border-top:1px solid #1e2622;margin-top:16px">
        <div style="font-size:11px;color:#5b6a61">© MANEXA · This is an automated message, please don't reply.</div>
      </td></tr>
    </table>
