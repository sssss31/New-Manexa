...
// server re-validates (never trust the client). Tuned for real consumer webcams
// in ordinary indoor light — the earlier values (minSharpness 12, minBrightness
// 55, minComposite 55) rejected most laptops/phones, leaving Capture permanently
// disabled. These still reject genuinely dark/blurry/empty frames.
