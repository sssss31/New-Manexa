...
import { BRAND_GREEN } from "@/lib/design-system";
  ...
  async function pay() {
    ...
    try {
      ...
      const rzp = new window.Razorpay!({
        ...
        // Razorpay's hosted checkout is a third-party iframe and cannot read
        // our CSS variables, so the brand accent is passed as a literal.
